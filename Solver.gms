...
/*Here,
    i -> number of rows (each row crane doesnt work then find the min/max or something)
    j -> number of columns
    l -> number of destination I want to create for the trucks to go to various cities
    k -> number of trucks
*/
...
/   1 10
    ...
    6 3
    7 9/
/*c(a) is the capcity of the a-th truck.*/
...
/   1 3
    ...
    6 1
    7 3/
/*len(a) is the length of the a-th truck.*/
...
/   1 5
    ...
    6 5
    7 10/
/*mil(a) is the mileage of the a-th truck.*/

dist(l)
/   1 50
    2 100/;
/*dis(a) is the distance a-th truck.*/
...
tc;
/*Here,
        a(i, j, k) = Binary variable which is 1 when kth truck is parked at the (i,j)th parking lot.
